-- Migration: Create student_personal_info table
-- This migration creates a separate table for personal information needed for OJT Journal
-- This is a better database design approach (normalization)

-- Create the student_personal_info table
