...
const menuItems: MenuItem[] = [
  { id: 'home', title: 'Dashboard', icon: 'home-outline', screen: 'Dashboard' },
  { id: 'interns', title: 'Interns', icon: 'school-outline', screen: 'Interns' },
  { id: 'coordinators', title: 'Coordinators', icon: 'people-outline', screen: 'Coordinators' },
  { id: 'companies', title: 'Companies', icon: 'business-outline', screen: 'Companies' },
  { id: 'appeals', title: 'Appeals', icon: 'mail-outline', screen: 'Appeals' },
  { id: 'messages', title: 'Messages', icon: 'chatbubbles-outline', screen: 'Messages' },
...
export default function SystemAdminDashboard({ onLogout, currentUser }: SystemAdminDashboardProps) {
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (profileResponse.success && profileResponse.user) {
          console.log('🔍 System admin dashboard profile data:', profileResponse.user);
        ...
        // Fetch notifications - placeholder for now (system admin notifications endpoint may need to be created)
  ...
  const refreshUserProfile = async () => {
    ...
    try {
      const profileResponse = await apiService.getProfile(currentUser.id);
      if (profileResponse.success && profileResponse.user) {
        console.log('🔄 Refreshing system admin profile:', profileResponse.user);
        setUserProfile({
          first_name: profileResponse.user.first_name || profileResponse.user.firstName || '',
          last_name: profileResponse.user.last_name || profileResponse.user.lastName || '',
          profile_picture: profileResponse.user.profile_picture || profileResponse.user.profilePicture,
    ...
    <View style={styles.container}>
      ...
      <View style={styles.mainContent}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerSubtitle}>System Admin</Text>
          </View>
      ...
      >
        <View style={styles.sidebarHeader}>
          ...
          <Text style={styles.sidebarSubtitle}>System Admin Dashboard</Text>
        </View>
            ...
            <View style={styles.userAvatar}>
              {userProfile?.profile_picture ? (
                ...
                <Text style={styles.userAvatarText}>
                  {userProfile?.first_name?.charAt(0) || currentUser?.email?.charAt(0) || 'S'}
            ...
            <View style={styles.userDetails}>
              <Text style={styles.userName}>
                {userProfile?.first_name && userProfile?.last_name 
                  ? `${userProfile.first_name} ${userProfile.last_name}`
                  : currentUser?.email?.split('@')[0] || 'System Admin'
                }
              </Text>
