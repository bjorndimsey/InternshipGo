...
interface Message {
  id: string;
  sender: string;
  senderType: 'student' | 'company' | 'coordinator' | 'admin' | 'system';
...
interface Conversation {
  id: string;
  participant: string;
  participantType: 'student' | 'company' | 'coordinator' | 'admin' | 'system';
  profilePicture?: string;
  lastMessage: string;
  timestamp: string;
  unreadCount: number;
...
export default function MessagesPage() {
      ...
      const mockConversations: Conversation[] = [
        {
          ...
          lastMessage: 'I need to discuss the new internship requirements with you.',
        ...
        },
        {
          ...
          lastMessage: 'I have a question about my internship application.',
      ...
      const mockMessages: Message[] = [
        {
          ...
          message: 'I need to discuss the new internship requirements with you.',
          timestamp: '2 hours ago',
          isRead: true,
          isImportant: true,
          priority: 'high',
        },
        {
          ...
          sender: 'You',
          senderType: 'admin',
          message: 'Sure, what specific requirements are you referring to?',
        ...
        },
        {
          ...
          sender: 'Dr. Sarah Johnson',
          senderType: 'coordinator',
          message: 'The new medical clearance requirements and updated application forms.',
  ...
  const getParticipantColor = (type: string) => {
    switch (type) {
      ...
      case 'coordinator': return '#fbbc04';
